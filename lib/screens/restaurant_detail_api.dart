...
class RestaurantDetailApi extends StatefulWidget {
  static const routeName = '/restaurant_detail';
  final String id;

  const RestaurantDetailApi({Key? key, required this.id}) : super(key: key);

  @override
  State<RestaurantDetailApi> createState() => _RestaurantDetailApiState();
}

class _RestaurantDetailApiState extends State<RestaurantDetailApi> {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DetailRestaurant>(
        ...
        builder:
          ...
          // print(snapshot.data!.restaurant.name);
