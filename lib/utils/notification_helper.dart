...
class NotificationHelper {
  ...
  Future<void> showNotification(
      ...
      DetailRestaurant detailRestaurant) async {
    var channelId = "1";
    var channelName = "channel_01";
    var channelDescription = "twentiecker restaurants channel";
    ...
    var titleRestaurants = detailRestaurant.restaurant.name;
  ...
  void configureSelectNotificationSubject(BuildContext context, String route) {
    selectNotificationSubject.stream.listen(
      (String payload) async {
        var data = DetailRestaurant.fromJson(json.decode(payload));
